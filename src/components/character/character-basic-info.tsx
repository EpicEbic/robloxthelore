      ...
      <div className="px-4 lg:px-6 py-3 bg-muted/20">
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <span className="font-medium flex-shrink-0 text-white">Species:</span>
            <span className="break-words hyphens-auto min-w-0 text-white">{species}</span>
          </div>
          
          <div className="flex items-center gap-2 min-w-0">
            <span className="font-medium flex-shrink-0 text-white">Age:</span>
            <span className="break-words hyphens-auto min-w-0 text-white">{age}</span>
          </div>
          
          <div className="flex items-center gap-2 min-w-0">
            <span className="font-medium flex-shrink-0 text-white">Alignment:</span>
