...
export function ComparisonSlot({
  ...
  return (
    <Card ref={setNodeRef} className={cn("min-h-[300px] h-full flex flex-col transition-all rounded-2xl overflow-hidden", isOver && "ring-2 ring-primary bg-primary/5", entry ? "border-0" : "border-dashed border-2")}>
