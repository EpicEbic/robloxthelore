...
export const renBytera: WikiEntry = {
  ...
  sections: {
    ...
    relationships: [
      ...
      "Vortex A. Steele - Acquaintance | Ren was introduced to Vortex through her connection to Nauli, and was commissioned to develop weapons for Vortex. As expected, Ren delivered and eventually produced the Magnetivolver and the Amplification Gauntlet, weapons that Vortex would go on to use many times. While Vortex and Ren never grew close, Ren was happy to see her work get put to good use and Vortex respected the craftsmanship that Ren had delivered upon.",
