...
export const theReckoner: WikiEntry = {
  ...
  carouselImages: [
    {
      url: "/lovable-uploads/0b4a8077-99a0-4535-a552-411748ec617e.png",
      caption: "The Reckoner's malevolent energy radiates from its possessed host."
    }
  ],
  ...
  combatStyles: [
    {
      ...
      combatStats: createCombatStats("Ø", "Ø", "S", "S", "Ø")
    }
  ],
  sections: {
    overview: [
      "The Reckoner is a major antagonist in The Lore, a reality-reset engine created by the occult leader 1x1x1x1. Its role in the story represents one of the greatest threats to the Bloxiverse, with the potential to reset reality itself.",
      "The Reckoner's existence drives much of the central conflict in The Lore, as the protagonists must find a way to prevent it from achieving its devastating purpose and destroying everything they know."
    ],
    combatStyles: [
      {
        id: "standard",
    ...
    appearance: [
      {
        ...
        label: "Formless",
        description: [
          "In the Reckoner's purest form, it exists as nothing more than a mass of energy, shaped to resemble the body of a Bloxian. Energy rapidly swirls around its body, jittering erratically as though desperate to find a host so its powers can be utilized."
        ],
        images: [
          {
      ...
      },
      {
        ...
        description: [
          "The Reckoner's influence has totally transformed Rice's Body, his skin adopting a sickly white tone. His wickered cone hat has become coated in the Reckoner's energy, turning an inky black with red highlights. His blue chest has turned a bright shade of crimson. All that remains of Rice is the Reckoner."
        ],
        images: [
          {
      ...
      },
      {
        ...
        description: [
          "Builderman has undergone significant changes to his body. His soft smile has been overtaken with a malevolent, unending grin. His hard-hat has turned black, with red accents. Similarly to other hosts of the Reckoner, Builderman's skin has gone a pale white."
        ],
        images: [
          {
    ...
    abilityData: {
      ...
      passives: {
        techniques: [
          ...
          {
            id: "eternal-wounding",
            title: "Eternal Wounding",
            description: [
              "Organic material struck by the Reckoner's energy-based projectiles suffer an affliction known as 'eternal wounding', permanently preventing their body from healing wounds naturally. It also reduces the effectiveness of anomalous sources of healing, such as the Bloxy Cola or the Regeneration Coil. This affliction disappears automatically if the Reckoner is recontained within the R-Orb."
            ]
          }
        ]
      },
      offensive: {
        techniques: [
          {
            id: "energy-projectiles",
            title: "Energy Projectiles",
            description: [
              "For those strong enough to survive its aura of death, its energy can be dealt out in the form of projectiles, including slashes, beams, bombs, and more. These energy-based projectiles are sharp and rigid, cutting and serrating through any material that may stand in their way."
            ]
          },
          {
