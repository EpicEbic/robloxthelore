    ...
    history: [
      ...
      },
      {
        ...
        description: [
          ...
          "His track running and stretching paid off significantly, as Volkan became quite an agile and flexible individual. Though he continued to train, he eventually hit the ceiling of physical potential he had, and only then was Volkan satisfied. But, in doing so he had gathered the attention of another.",
          "An old, elderly man approached Volkan one day, complimenting him on his prowess and determination. He went on to mention how Volkan had the skills and physique, yet no work to apply them to. The two chatted and eventually became friendly with one another, before Volkan was referred to the Hunter Association for a line of work the man believed he would specialize in.",
