...
export const whatsNewEntries: WhatsNewEntry[] = [
  {
    ...
    description: "The largest upgrade of the lore to-date, restructuring the entire website in preparation for the official plot. Alongside a completely rebuilt UI and backend, almost every aspect of the website has been improved or optimized in one way or another.",
    changes: [
      { text: "The entire website has had its UI and design structure entirely rebuilt from the ground up, complete with a fresh and finalized UI that is far easier to navigate, as well as complete mobile support site-wide. Every single main and side page have received visual overhauls and plenty of adjustments.", category: "new" },
      { text: "Alongside the complete UI overhaul brings the entry overhaul. All entries have received a full treatment with a partial redesign to the UI, themes (if they had one), and structure! Entries are significantly cleaner now, reformed to fit the modern UI and provide more information cleanly. Of course, they also look better on mobile now, too.", category: "new" },
      { text: "The website has undergone significant reordering following the introduction of a new 'Part' system. The entire site is now divided into these parts, with entries and certain tools now focusing on what part you're viewing. This feature is mostly untouched for now, but this will allow me to create 'Part 2' and 'Part 3' variants of characters later on, as well as show specific entries of characters that only appear in certain parts.", category: "new" },
      ...
      { text: "Two new easter egg phrases have been added. Note that these are less of a joke, and more of a personal reflection on my life and relationship with The Lore over the years. Do not expect hidden entries or content, only commentary.", category: "new" },
      { text: "As the official canon is in the works, existing character entries didn't entirely line up or hold true to the series anymore. Most entries have been disabled or hidden, and will return slowly as the changes for each one are finalized.", category: "changes" },
      { text: "Caesar Bloxwright (Part 1) was rewritten to fit properly with the canon timeline. His entry is not fully complete (although very close), but remains open for viewers to get a sense of the reworked character entry system.", category: "changes" },
      { text: "Nauli Parter (Part 1) has been disabled, pending an update.", category: "changes" },
      { text: "Vortex A. Steele (Part 1) has been disabled, pending an update.", category: "changes" },
      { text: "Rice Farmer (Part 1) has been disabled, pending an update.", category: "changes" },
      { text: "Ren Bytera (Part 1) has been disabled, pending an update.", category: "changes" },
      { text: "Bryck Manning (Part 1) has been disabled, pending an update.", category: "changes" },
      { text: "Builderman (Part 1) has been hidden.", category: "changes" },
      { text: "Bloxxanne (Part 1) Whelder has been hidden.", category: "changes" },
      { text: "Spawnboy (Part 1) has been hidden.", category: "changes" },
      { text: "The Breadwinner has been hidden.", category: "changes" },
      { text: "The Coils of Power have been disabled, pending an update.", category: "changes" },
      { text: "The Banhammer has been hidden.", category: "changes" },
      { text: "There is now visual feedback when typing an easter egg, through a text box that appears at the top of your screen. The box will appear when typing a valid phrase, and flicker red if an incorrect letter is typed. This greatly reduces the amount of guesswork, turning it more into a game of trial and error.", category: "changes" },
